            ...
            <div className="flex flex-col items-center justify-center gap-6 lg:flex-row lg:items-stretch lg:gap-8">
              {tabData[activeTab].plans.map((plan, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`relative flex w-full max-w-md flex-col overflow-hidden rounded-[18px] border p-6 transition-all duration-300 lg:w-1/3 ${isEntrepreneur
                      ...
                      : "group border-[#8A6B3F] text-black hover:-translate-y-1 hover:border-[#2FB4FF] hover:!shadow-[0_0_0_1px_rgba(47,180,255,0.50),0_0_24px_rgba(47,180,255,0.45),0_14px_36px_rgba(0,0,0,0.45),0_50px_50px_-20px_rgba(120,90,20,1)]"
                      }`}
                    style={{
                      background: isEntrepreneur
                        ? "radial-gradient(140% 140% at 50% 10%, #00152e 30%, #003a61 60%, #005f9e 100%)"
                        : "linear-gradient(180deg, rgba(215,181,109,0.18) 0%, rgba(176,141,87,0.92) 35%, rgba(138,107,63,0.98) 100%)",
