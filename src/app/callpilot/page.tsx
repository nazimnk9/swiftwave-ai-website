      ...
      <main className="pt-[120px] md:pt-[145px] lg:pt-[160px]">
        ...
        <section className="bg-white py-20 border-b border-gray-100">
          <div className="container mx-auto px-6 sm:px-8 max-w-4xl text-center">
            <h2 className="text-3xl sm:text-4xl font-black text-[#05070A] tracking-tight mb-4">
              Choose Your Screening Plan
            </h2>
            <p className="text-lg sm:text-xl font-bold text-[#36454F] mb-8">
              CallPilot pricing has moved to CallPilot.pro.
            </p>
            <Link href="https://callpilot.pro/pricing" target="_blank" rel="noopener noreferrer">
              <Button className="btn-white-section">
                View Pricing on CallPilot.pro
              </Button>
            </Link>
          </div>
        </section>
