      ...
      <div className="container mx-auto pl-0 pr-[18px] sm:pl-0 sm:pr-[26px] lg:pl-0 lg:pr-[35px]">
        <div className="flex items-center justify-between h-[120px] md:h-[145px] lg:h-[160px]">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <div ref={dropdownRef} className="relative">
              <button
                ...
                className="flex items-center gap-1.5 text-gray-600 hover:text-gray-900 transition-colors font-medium py-2 focus:outline-none"
                aria-haspopup="true"
              ...
              {appsOpen && (
                <div
                  className="absolute top-full left-0 mt-2 w-64 bg-white border border-gray-100 rounded-lg shadow-xl py-2 z-50 animate-fade-in"
                  onMouseLeave={() => setAppsOpen(false)}
                >
                  {appsList.map((app) => (
                    <div
                      key={app.label}
                      className="px-4 py-2.5 flex flex-col hover:bg-gray-50 transition-colors border-b border-gray-50 last:border-b-0"
                    >
                      <span className="font-semibold text-gray-950 text-sm">{app.label}</span>
                      <span className="text-[10px] text-gray-400 font-medium mt-0.5 tracking-wider uppercase">{app.status}</span>
                    </div>
                  ))}
                </div>
              )}
          ...
          <div className="md:hidden flex items-center gap-4">
            ...
            <button
              className="p-3 text-gray-900 flex items-center justify-center inline-flex"
            ...
            <nav className="flex flex-col gap-4">
              ...
              <div className="px-2">
                <button
                  ...
                  className="flex items-center justify-between w-full text-gray-600 hover:text-gray-900 transition-colors font-medium py-2 focus:outline-none"
                >
                  <span>Apps</span>
                  <ChevronDown size={16} className={`transition-transform duration-200 ${mobileAppsOpen ? "rotate-180" : ""}`} />
                </button>
                {mobileAppsOpen && (
                  <div className="mt-2 pl-4 border-l border-gray-100 flex flex-col gap-3 py-1">
                    {appsList.map((app) => (
